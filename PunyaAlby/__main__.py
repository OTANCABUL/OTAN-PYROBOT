...
async def main():
    ...
    LOGGER("PunyaAlby").info(f"OTAN-PYROBOT v{BOT_VER} [🥵 BERHASIL DIAKTIFKAN! 🥵]")
    ...
    if bot1 and str(BOTLOG_CHATID).startswith("-100"):
        ...
        await bot1.set_chat_photo(BOTLOG_CHATID, photo="PunyaAlby/resources/albyy.jpg")
    await idle()
    await aiosession.close()


if __name__ == "__main__":
    LOGGER("PunyaAlby").info("Starting OTAN-PYROBOT")
    install()
    git()
    heroku()
