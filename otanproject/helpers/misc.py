...
from otanproject import LOGGER
...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("otanproject").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("otanproject").info(f"Invalid Git Command")
        ...
        LOGGER("otanproject").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("otanproject").info(f"Heroku App Configured")
